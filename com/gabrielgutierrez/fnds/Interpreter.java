...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    String interpret(Expr expression) {
        try {
            ...
            Foundations.runtimeError(error);
            return null;
        }
    }
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        if (stmt.superclass != null) {
            ...
            if (!(superclass instanceof FoundationsClass)) {
        ...
        FoundationsClass metaclass = new FoundationsClass(null, (FoundationsClass) superclass,
        ...
        FoundationsClass klass = new FoundationsClass(metaclass, (FoundationsClass) superclass, stmt.name.lexeme, methods);
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        FoundationsClass superclass = (FoundationsClass) environment.getAt(
                distance, "super");
